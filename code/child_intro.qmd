...
This report compares the distribution and relative abundance of `r length(spp)` snailfish species (specifically, `r paste(spp, collapse = ", ")`; @fig-snailfish) with maps from the `r {{params$report_year}}` in the eastern Bering sea shelf bottom trawl survey. Survey results reported herein include estimates of catch-per-unit-effort for most snailfishes and geographic distributions (@fig-map-all-spp-{{params$report_year}}); {{params$citation}}). In {{params$report_year}}, snail fish were caught at `r length(unique(dat0$station))` stations. Data is publicly available from the Fisheries One Stop Shop [@FOSSAFSCData]. 

```{r}
#| label: fig-snailfish
#| fig-cap: "A photo of snailfishes. "

# "https://raw.githubusercontent.com/afsc-gap-products/gap_bs_data_report/main/img/snailfishes-crop.png"
knitr::include_graphics("https://raw.githubusercontent.com/afsc-gap-products/gap_bs_data_report/refs/heads/main/img/snailfishes-crop.png")
# knitr::include_graphics("https://github.com/afsc-gap-products/gap_bs_data_report/blob/main/img/snailfishes-crop.png?raw=true")
```
...
pp <- ggplot2::ggplot() +
  ...
  ggplot2::ggtitle( # plot title
    label = paste0("Snailfish Presence in ", {{params$report_year}}), 
